									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<thead>
											<tr>
												...
												<th class="border-bottom-0">User Feedback</th>
										...
										<tbody>
											<?php 
												 $count=1; 
												 $query="select f.*,t.*,b.* from tbl_user_feedback f,tbl_travel_company t,tbl_booking b where f.fld_booking_id=b.fld_booking_id and b.fld_travel_comp_id=t.fld_travel_comp_id group by f.fld_feedback_id order by f.fld_feedback_id desc";
