				...
				<div class="p-5 wd-md-50p">
					<div class="main-signin-header">
						...
						<form method="post">
							...
							<button type="submit" name="login" class="btn btn-main-primary btn-block">Sign In</button>
						</form>
					</div>
...
<?php 
    ...
    if(isset($_POST['login']))
    {
      ...
      $fld_admin_email = mysqli_real_escape_string($connect,$_POST['email']);
      $fld_admin_password= mysqli_real_escape_string($connect,$_POST['password']);

      $sel = mysqli_query($connect,"select * from tbl_admin where fld_admin_email ='$email' and fld_admin_password ='$password'")or die($mysqli_error($connect));
      ...
      if (mysqli_num_rows($sel)>0)
      {
          ...
          $_SESSION['email'] = $fetch['fld_admin_email'];
