...
<head>
		...
		<!-- Title -->
		<title>Approved Packages View </title>
					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Approved Packages View</li>
							</ol>
						</nav>
					</div>
								...
								<div class="table-responsive">
									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php 
												 $count=1; 
												 $query="select p.*,l.*,h.*,t.*,f.*,s.*,tc.* from tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type f,tbl_spot s,tbl_travel_company tc
					                                     		where
											...
											<tr>
												...
												<td><span class="badge badge-success"><?php echo $fld_package_status; ?></span></td>
