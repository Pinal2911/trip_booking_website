...
<head>
		...
		<!-- Title -->
		<title>Register Packages View </title>
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-2 mt-2">Packages</h4>
									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<thead>
											<tr>
												...
												<th class="border-bottom-0">Travel Company name</th>
												<th class="border-bottom-0">Package Name</th>
												<th class="border-bottom-0">No of Nights</th>
												...
												<th class="border-bottom-0">Package Amount</th>
										...
										<tbody>
											<?php 
												 ...
												 $query="select p.*,l.*,h.*,t.*,ft.*,s.*,tc.* from tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type ft,tbl_spot s,tbl_travel_company tc
					                                     		where
				                                      			...
				                                      			p.fld_package_delete=0 and p.fld_package_status='Register' group by p.fld_package_id order by p.fld_package_id desc";
											...
											<tr>
												...
												<td>
													<a href="packages_approved.php?id=<?php echo $fetch['fld_package_id']; ?>" class="fa fa-thumbs-up"  style="color: green;font-size: 20px;" title="Approved"></a>
													<a href="packages_disapproved.php?id=<?php echo $fetch['fld_package_id']; ?>" class="fa fa-thumbs-down"  style="color: red;font-size: 20px;" title="Disapproved"></a>
													<a href="packages_delete.php?id=<?php echo $fetch['fld_package_id']; ?>" class="fa fa-trash"  style="color: gray;font-size: 20px;" onclick="return confirm('Are you sure you want to delete')"></a>
													<a href="packages_update.php?id=<?php echo $fetch['fld_package_id']; ?>"><i class="fa fa-edit" style="color: blue;font-size: 20px;"></i></a>
													
												</td>
												<td><span class="badge badge-warning"><?php echo $fld_package_status; ?></span></td>
												<td><?php echo $fld_travel_comp_name; ?></td>
												<td><?php echo $fld_package_name; ?></td>
												<td><?php echo $fld_no_nights; ?></td>
												...
												<td><del>&#8377;<?php echo $fld_total_rate; ?></del> 
													<span style="color: red">( <?php echo $fld_package_discount; ?>%) </span><br> 
													<b>	&#8377;<?php echo $fld_package_amt; ?></b>
												</td>
												<td><?php echo $fld_package_created_date; ?></td>
											</tr>
											<?php }?>
										</tbody>
