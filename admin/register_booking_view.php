									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
												 ...
												 $query="select b.*,p.*,l.*,h.*,t.*,ft.*,s.*,u.* from tbl_booking b,tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type ft,tbl_spot s,tbl_user u
					                                     		where
				                                      			b.fld_loc_id=l.fld_loc_id and
				                                      	 		...
				                                      	 		b.fld_package_id=p.fld_package_id and
											...
											<tr>
												...
												<td>
													<a href="booking_approved.php?id=<?php echo $fetch['fld_booking_id']; ?>" class="fa fa-thumbs-up"  style="color: green;font-size: 20px;" title="Confirm Booking"></a>
												</td>
