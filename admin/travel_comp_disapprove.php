...
<head>
		...
		<!-- Title -->
		<title> Admin - Disapproved Travel Company</title>
					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Disapproved Travel Company</li>
							</ol>
						</nav>
					</div>
				</div>
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mg-b-2 mt-2">Disapproved Travel Company</h4>
								...
								<div class="table-responsive">
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php 
								                    $count=0;
								                    $query1="select * from tbl_travel_company where fld_travel_comp_status='Disapproved' order by fld_travel_comp_id asc";
								            ...
								            <tr>
												...
												<td><span class="badge badge-danger"><?php echo $fld_travel_comp_status; ?></span></td>
