					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Register Booking View</li>
							</ol>
						</nav>
					</div>
				</div>
								...
								<div class="table-responsive">
									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php 
												 $count=1; 
												 $query="select b.*,p.*,l.*,h.*,t.*,ft.*,s.*,u.* from tbl_booking b,tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type ft,tbl_spot s,tbl_user u
					                                     		where
				                                      			b.fld_loc_id=l.fld_loc_id and
				                                      	 		...
				                                      	 		b.fld_package_id=p.fld_package_id and b.fld_travel_comp_id='".$_SESSION['id']."' AND
											...
											<tr>
												...
												<td>
													...
													<a href="booking_approved.php?id=<?php echo $fetch['fld_booking_id']; ?>" class="fa fa-thumbs-up"  style="color: green;font-size: 20px;" title="Approved"></a>
													
													<a href="booking_disapproved.php?id=<?php echo $fetch['fld_booking_id']; ?>" title="Disapproved"><i class="far fa-thumbs-down" style="color: red;font-size: 20px;"></i></a>
												</td>
