									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
												 ...
												 $query="select b.*,p.*,l.*,h.*,t.*,ft.*,s.*,u.*,cp.* from tbl_custumize_booking b,tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type ft,tbl_spot s,tbl_user u,tbl_custumize_package cp
					                                     		where
				                                      			b.fld_loc_id=l.fld_loc_id and
				                                      	 		...
				                                      	 		b.fld_custumize_id=cp.fld_custumize_id and b.fld_travel_comp_id='".$_SESSION['id']."' AND
				                                      	 		b.fld_booking_status='Approved' group by b.fld_booking_id order by b.fld_booking_id desc";
											...
											<tr>
												...
												<td><span class="badge badge-success"><?php echo $fld_booking_status; ?></span></td>
