								...
								<div class="table-responsive">
									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php 
												 $count=1; 
												 $query="select b.*,p.*,l.*,h.*,t.*,ft.*,s.*,u.*,cp.* from tbl_custumize_booking b,tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type ft,tbl_spot s,tbl_user u,tbl_custumize_package cp
					                                     		where
				                                      			b.fld_loc_id=l.fld_loc_id and
				                                      	 		l.fld_loc_id=h.fld_loc_id and
				                                      	 		l.fld_loc_id=t.fld_loc_id and
				                                      	 		b.fld_loc_id=s.fld_loc_id and
				                                      	 		p.fld_transport_id=t.fld_transport_id and
				                                      	 		h.fld_hotel_id=ft.fld_hotel_id and
				                                      	 		p.fld_food_type_id=ft.fld_food_type_id and
				                                      	 		b.fld_user_id=u.fld_user_id and
				                                      	 		b.fld_custumize_id=cp.fld_custumize_id and
				                                      	 		b.fld_travel_comp_id='".$_SESSION['id']."' AND b.fld_booking_status='Register' group by b.fld_booking_id order by b.fld_booking_id desc";
											...
											<tr>
												...
												<td>
													...
													<a href="custumize_booking_approved.php?id=<?php echo $fetch['fld_booking_id']; ?>" class="fa fa-thumbs-up"  style="color: green;font-size: 20px;" title="Approved"></a>
													
													<a href="custumize_booking_disapproved.php?id=<?php echo $fetch['fld_booking_id']; ?>" title="Disapproved"><i class="far fa-thumbs-down" style="color: red;font-size: 20px;"></i></a>
												</td>
												<td><span class="badge badge-warning"><?php echo $fld_booking_status; ?></span></td>
