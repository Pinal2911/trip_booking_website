				...
				<div class="main-content-body">
					<div class="row row-sm">
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
							  <?php 
                                    $query_sprofile1="select * from tbl_travel_company where fld_travel_comp_email='".$_SESSION['email']."' ";
										...
										<div class="project-content">
											...
											<ul>
												<li>
													...
													<span><?php echo mysqli_num_rows($view_sprofile1) ?></span>
												</li>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
							<?php 
                                    $query_sprofile="select * from tbl_tour_location order by fld_loc_id desc";
                                    $view_sprofile=mysqli_query($connect,$query_sprofile);
								...
								<div class="card-body">
									<div class="d-flex">
										...
										<div class="project-content">
											...
											<ul>
												<li>
													<strong>No. of Tour Locations</strong>
													<span><?php echo mysqli_num_rows($view_sprofile) ?></span>
												</li>

												<li>
													<a href="tour_location_view.php">View</a>
												</li>
											</ul>
										</div>
									</div>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
							<div class="card overflow-hidden project-card">
								<?php 
                                    $query_sprofile3="select * from tbl_booking where fld_booking_status='Approved' order by fld_booking_id desc";
                                    $view_sprofile3=mysqli_query($connect,$query_sprofile3);
								...
								<div class="card-body">
									<div class="d-flex">
										...
										<div class="project-content">
											...
											<ul>
												<li>
													<strong>No of Confirm Booking</strong>
													<span><?php echo mysqli_num_rows($view_sprofile3) ?></span>
												</li>
						...
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
							<?php 
                                    $query_sprofile4="select * from tbl_package order by fld_package_id desc";
                                    $view_sprofile4=mysqli_query($connect,$query_sprofile4);
										...
										<div class="project-content">
											...
											<ul>
												<li>
													...
													<span><?php echo mysqli_num_rows($view_sprofile4) ?></span>
												</li>
												<li>
													<a href="packages_register_view.php">View</a>
					...
					<div class="row row-sm">
						<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
							  <?php 
                                    $query_sprofile1="select * from tbl_booking order by fld_booking_id desc";
                                    $view_sprofile1=mysqli_query($connect,$query_sprofile1);
								...
								<div class="card-body">
									<div class="d-flex">
										...
										<div class="project-content">
											...
											<a href="travel_comp_view.php"> View</a>
										</div>
									</div>
								</div>
							</div>
						...
						<!-- <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
							<?php 
                                    $query_sprofile="select * from tbl_user order by fld_user_id desc";
                                    $view_sprofile=mysqli_query($connect,$query_sprofile);
						...
						<!-- <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
							<div class="card overflow-hidden project-card">
								<?php 
                                    $query_sprofile3="select * from tbl_hotel order by fld_hotel_id desc";
                                    $view_sprofile3=mysqli_query($connect,$query_sprofile3);
								...
								<div class="card-body">
									<div class="d-flex">
										...
										<div class="project-content">
											...
											<ul>
												<li>
													<strong>No of Hotels</strong>
													<span><?php echo mysqli_num_rows($view_sprofile3) ?></span>
												</li>

												<li>
													<a href="hotel_view.php">View</a>
												</li>
											</ul>
										</div>
									</div>
