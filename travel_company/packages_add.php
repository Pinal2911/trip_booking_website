...
<body class="main-body  app dark-theme">
	...
	<?php 	
		if(isset($_POST['submit']))
		{
			...
			$ins="insert into tbl_package(fld_package_name,fld_no_nights,fld_travel_comp_id,fld_loc_id,fld_hotel_id,fld_room_id,fld_food_type_id,fld_spot_id , fld_transport_id,fld_package_rate,fld_package_profit,fld_total_rate,fld_package_amt,fld_package_discount) 
				values('$package_name','$no_nights','".$_SESSION['id']."','".$_POST['location']."','".$_POST['hotel']."','".$_POST['room']."','".$_POST['food_type']."','".$_POST['spot']."','".$_POST['transport']."','$packages_rate','$profit_amount','$total_rate','$total_amount','$discount_amount')";
