									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<thead>
											<tr>
												...
												<th class="border-bottom-0">Paackage Amount</th>
										...
										<tbody>
												 ...
												 $query="select p.*,l.*,h.*,t.*,ft.*,s.* from tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type ft,tbl_spot s
					                                     		where
				                                      			p.fld_loc_id=l.fld_loc_id and
		                                      	 				...
		                                      	 				ft.fld_food_type_id=p.fld_food_type_id and
				                                      			p.fld_package_delete=0 and p.fld_travel_comp_id='".$_SESSION['id']."' and fld_package_status='Approved' group by p.fld_package_id order by p.fld_package_id desc";
											...
											<tr>
												...
												<td>
													<a href="packages_disapproved.php?id=<?php echo $fetch['fld_package_id']; ?>" title="Disapproved"><i class="far fa-thumbs-down" style="color: red;font-size: 20px;"></i></a>
												</td>
												<td><span class="badge badge-success"><?php echo $fld_package_status; ?></span></td><td><?php echo $fld_package_name; ?></td>
