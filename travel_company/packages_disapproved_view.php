...
<head>
		...
		<!-- Title -->
		<title>Disapproved Packages View </title>
					...
					<div>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Disapproved Packages View</li>
							</ol>
						</nav>
					</div>
				</div>
									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php 
												 ...
												 $query="select p.*,l.*,h.*,t.*,ft.*,s.* from tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type ft,tbl_spot s
					                                     		where
				                                      			...
				                                      			p.fld_package_delete=0 and p.fld_travel_comp_id='".$_SESSION['id']."' and fld_package_status='Disapprove' group by p.fld_package_id order by p.fld_package_id desc";
											...
											<tr>
												...
												<td><span class="badge badge-danger"><?php echo $fld_package_status; ?></span></td>
