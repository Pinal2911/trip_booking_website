									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php 
												 ...
												 $query="select p.*,l.*,h.*,t.*,ft.*,s.* from tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type ft,tbl_spot s
					                                     		where
				                                      			...
				                                      			p.fld_package_delete=0 and p.fld_package_status='Register' and p.fld_travel_comp_id='".$_SESSION['id']."'group by p.fld_package_id order by p.fld_package_id desc";
											...
											<tr>
												...
												<td>
													<a href="packages_update.php?id=<?php echo $fetch['fld_package_id']; ?>"><i class="fa fa-edit" style="color: green;font-size: 20px;"></i></a>
													<a href="packages_delete.php?id=<?php echo $fetch['fld_package_id']; ?>" class="fa fa-trash"  style="color: red;font-size: 20px;" onclick="return confirm('Are you sure you want to delete')"></a>
												</td>
