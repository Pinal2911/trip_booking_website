		...
		<?php 	
			if(isset($_POST['submit']))
			{
				extract($_POST);
					 ...
					 $ins="insert into tbl_booking(fld_booking_date, fld_user_id, fld_user_mobileno, fld_no_of_adult, fld_no_of_child, fld_total_booking_amount, fld_travel_comp_id, fld_loc_id, fld_hotel_id, fld_food_type_id, fld_spot_id, fld_transport_id, fld_package_id)values('$dep_date','".$_SESSION['id']."','$phone_no','$adult','$child','$total_packages_rate','$fld_travel_comp_id','$fld_loc_id','$fld_hotel_id','$fld_food_type_id','$fld_spot_id','$fld_transport_id','$fld_package_id')";
