	...
	<body class="main-body  app dark-theme">
						...
						<div class="card">
							<div class="card-body">
								...
								<form method="POST" class="form-horizontal form-bordered" onsubmit="return validateForm()" enctype="multipart/form-data">
									<?php 
										 $count=1; 
										 $query="select p.*,l.*,h.*,t.*,f.*,ft.*,s.* from tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food f,tbl_food_type ft,tbl_spot s
			                                     		where
		                                      			p.fld_loc_id=l.fld_loc_id and
		                                      	 		...
		                                      	 		h.fld_hotel_id=f.fld_hotel_id and
		                                      	 		f.fld_food_type=ft.fld_food_type and
											...
											<div class="col-md-12 col-lg-12">
												<table  class="table table-hover small-text" id="tb">
														...
														<tr>
															<td></td>
															<td>
																<input type="text" class="form-control" name="adult" id="adult" placeholder="Adult"  minlength="2" maxlength="2"  oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" onkeyup="tot_package_rate()" required="">
																<center>12 +yrs</center>
															</td> 															
															<td>
																<input type="text" class="form-control" name="child" id="child" placeholder="Child" minlength="2" maxlength="2"  onkeyup="tot_package_rate()" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" required="">
										...
										<div class="table-responsive mg-t-20">
											<table class="table table-bordered">
												<tbody>
													<tr>
														<td>Package Rate</td>
														<td class="text-right"><input type="text" name="packages_rate" id="packages_rate" class="form-control text-right" readonly="" value="<?php echo $fld_package_amt; ?>"></td>
													</tr>
													<tr>
														<td>Total Amount</td>
		...
		<?php 	
			if(isset($_POST['submit']))
			{
				...
				echo $ins="insert into tbl_booking(fld_booking_date, fld_user_id, fld_user_mobileno, fld_no_of_adult, fld_no_of_child, fld_total_booking_amount, fld_travel_comp_id, fld_loc_id, fld_hotel_id, fld_food_id, fld_spot_id, fld_transport_id, fld_package_id)values('$dep_date','".$_SESSION['id']."','$phone_no','$adult','$child','$total_packages_rate','$fld_travel_comp_id','$fld_loc_id','$fld_hotel_id','$fld_food_id','$fld_spot_id','$fld_transport_id','$fld_package_id')";
					...
					{
						echo "<script>";
						echo "alert('Book Send to Admin Successfully');";
