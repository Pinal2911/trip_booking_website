								...
								<div class="table-responsive">
									...
									<table id="example" class="table key-buttons text-md-nowrap">
										...
										<tbody>
											<?php 
												 $count=1; 
												 $query="select b.*,p.*,l.*,h.*,t.*,ft.*,s.* from tbl_booking b,tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type ft,tbl_spot s
					                                     		where
											...
											<tr>
												...
												<td>
													<a href="booking_delete.php?id=<?php echo $fetch['fld_booking_id']; ?>" class="fa fa-trash"  style="color: red;font-size: 20px;" onclick="return confirm('Are you sure you want to delete')" title="Delete"></a>
