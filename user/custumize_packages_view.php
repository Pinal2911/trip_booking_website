...
<body class="main-body  app dark-theme">
		...
		<div class="main-content horizontal-content">
			...
			<div class="container">
				...
				<div class="row">
					<?php 
						  $query="select p.*,l.*,h.*,t.*,ft.*,s.*,tc.*,cp.*,r.* from tbl_package p,tbl_tour_location l, tbl_hotel h,tbl_transport_mode t,tbl_food_type ft,tbl_spot s,tbl_travel_company tc,tbl_custumize_package cp,tbl_room r
                         		where
                      			...
                      			cp.fld_package_delete=0 and cp.fld_package_status='Approved' group by cp.fld_custumize_id order by cp.fld_custumize_id desc";
							...
							<div class="card-body text-center">
								<div class="row">
									...
									<div class="col-md-6">
										...
										<a href="custumize_booking_add.php?id=<?php echo $fetch['fld_custumize_id']; ?>"><button class="btn btn-danger pd-x-20 mg-t-10" type="submit">Book Now</button></a>
									</div>
								</div>
							</div>
						</div>
