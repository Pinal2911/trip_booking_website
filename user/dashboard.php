							...
							<div class="card overflow-hidden project-card">
								<div class="card-body">
									<div class="d-flex">
										...
										<?php 
		                                    $query_slider1="select * from tbl_custumize_package where fld_package_status='Approved' order by fld_custumize_id desc";
		                                    $view_slider1=mysqli_query($connect,$query_slider1);
		                                ?>
										<div class="project-content">
											<h6>Custumize Package</h6>
											<ul>
												<li>
													<strong>Custumize Package View</strong>
													<span><?php echo mysqli_num_rows($view_slider1) ?></span>
												</li>
												<a href="custumize_package_view.php"> View</a>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="card  overflow-hidden project-card">
								<div class="card-body">
									<div class="d-flex">
										...
										<?php 
		                                    $query_slider1="select * from tbl_booking where fld_booking_status='Register' order by fld_booking_id desc";
		                                    $view_slider1=mysqli_query($connect,$query_slider1);
		                                ?>
										<div class="project-content">
											<h6>Register Booking</h6>
											<ul>
												<li>
													<strong>Register</strong>
													<span><?php echo mysqli_num_rows($view_slider1) ?></span>
												</li>
												<a href="booking_view.php"> View</a>
											</ul>
										</div>
									</div>
								</div>
								...
								<div class="card-body">
									<div class="d-flex">
										<div class="my-auto">
		                                    ...
		                                    $query_slider1="select * from tbl_booking where fld_booking_status='Approved' order by fld_booking_id desc";
		                                    $view_slider1=mysqli_query($connect,$query_slider1);
		                                ?>
										<div class="project-content">
											...
											<ul>
												...
												<a href="confirm_booking_view.php"> View</a>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="card">
								<div class="card-header pt-4 pb-0">
									<div class="d-flex justify-content-between">
										...
										<h4 class="card-title mg-b-10 ">Package Statistics</h4>
									...
									<div class="">
										<div class="row">
											<div class="col-md-6 col-6 text-center">
												<?php 
				                                    $query_slider1="select * from tbl_package where fld_package_status='Approved' order by fld_package_id desc";
				                                    $view_slider1=mysqli_query($connect,$query_slider1);
				                                ?>
												<div class="task-box primary mb-0">
													<p class="mb-0 tx-12">Total Packages</p>
													<h3 class="mb-0"><?php echo mysqli_num_rows($view_slider1) ?></h3>
												</div>
											</div>
											<div class="col-md-6 col-6 text-center">
												<?php 
												...
												<div class="task-box danger  mb-0">
													<p class="mb-0 tx-12">Total Custumize Package</p>
													<h3 class="mb-0"><?php echo mysqli_num_rows($view_slider1) ?></h3>
												</div>
											</div>
										</div>
